...
`kernel.graph` and threaded through as parameters so that policy stays
...
if TYPE_CHECKING:
    ...
    from atlas_engine.kernel.profiles import HarnessProfile
    ...
    *,
    ...
    if forbidden_classes or forbidden_names:
        ...
        from atlas_engine.kernel.profiles.harness.harness_profiles import (
            _format_scaffolding_rejection,  # noqa: PLC0415
        )
